...
public class ItemDust extends Item {
	...
	public ItemDust() {
		super();
		String itemName = TechniumMod.MODID + "_" + "itemDust";
	...
	public static final String[] names = new String[] { "dustCopper", "dustTin", "dustLead" , "dustSilver", "dustIron", "dustGold", "dustWolframite" };
